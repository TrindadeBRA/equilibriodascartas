      ...
      <tbody class="divide-y divide-gray-100 border-t border-gray-100">
        ...
        <tr class="hover:bg-gray-50">
          ...
          <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
            <div class="text-sm">
              <div class="font-medium text-gray-700">Nome do Cliente</div>
              <div class="text-gray-400">E-mail do Cliente</div>
            </div>
          </th>
          ...
          {{-- Nascimento / Signo --}}
          <td class="px-6 py-4">
            <div class="text-gray-400">01/01/1990</div>
            <div class="font-medium text-gray-700">Leão</div>
          </td>

          {{-- Celular --}}
          <td class="px-6 py-4">
            <div class="flex gap-2">
              <div class="text-gray-400">(11) 00000-0000</div>
            </div>
          </td>
          ...
          <td class="px-6 py-4">
            <div class="flex gap-2">
              <div class="font-medium text-gray-700">teste@teste.com</div>
            </div>
          </td>
